(function($) {
  ...
  $("#publish-report").on('click', function() {
    ...
    var str="今日("+date.getFullYear()+"年"+(date.getMonth()+1)+"月"+date.getDate()+"日"+")，本市车流总量2997471辆，同比（2963475辆）上升1.1%，外牌车辆总数1852235辆，占比38.25%，同比（1657239辆）上升11.7%，外牌车辆主要归属外省258936辆，同比（264863辆）下降2.2%，佛山201834辆，同比（195317辆）上升3.3%。社情民意的关注度973条，社情民意热点“内环路上下班拥堵”、“龙口西往天河北方向闯红灯现象多”等，民意满意度99分--"+now;
    publishWechat(str);
