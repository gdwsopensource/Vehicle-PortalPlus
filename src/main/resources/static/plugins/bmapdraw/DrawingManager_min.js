...
(function() {
  ...
  d.prototype._addGeoUtilsLibrary = function() {
    if (!BMapLib.GeoUtils) {
      ...
      g.setAttribute("src",
          "/plugins/bmapdraw/GeoUtils_min.js");
  ...
  function a(h, g) {
    ...
    this.defaultDrawingModes = [ BMAP_DRAWING_CIRCLE,BMAP_DRAWING_RECTANGLE ];
    if (g.drawingModes) {
  ...
  a.prototype._setScale = function(j) {
    ...
    this.container.style.cssText = [ "-moz-transform: scale(" + j + ");",
        "-o-transform: scale(" + j + ");",
        "-webkit-transform: scale(" + j + ");", "transform: scale(" + j + ");",
        "margin-left:" + k + "px;", "margin-top:" + h + "px;",
        "*margin-left:0px;", "*margin-top:0px;", "margin-left:0px\\0;",
        "margin-top:0px\\0;",
        "filter: progid:DXImageTransform.Microsoft.Matrix(", "M11=" + j + ",",
        "M12=0,", "M21=0,", "M22=" + j + ",", "SizingMethod='auto expand');" ]
        .join("")
  };
